...
#Recipe(
  ...
  Gear:
  - [\*] Dutch oven#fn[A bread steel should, hypothetically, also work. Don't own one;
      don't know.]
  - [\*] Parchment paper


  // Wouldn't it be less of a headache if we just multiplied by like 1.1 to get
  // nice round metric units?
  Soaker:
  - 141g rolled oats #aside[285mℓ]
  - 113mℓ boiling water
